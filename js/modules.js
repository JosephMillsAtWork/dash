...
var simpleTableModules = [
    ...
    { 
        name: 'aptPackages',
        template: '<key-value-list heading="System Upgrades" module-name="update_script"></key-value-list>'

    },
    {
        name: 'backupInfo',
        template: '<table-data heading="Mounted Backups" module-name="backup_info"></table-data>'
    },
];
